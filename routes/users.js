...
const express = require("express"),
    ...
    succeed = require("../../event-schedule/util/responseBuilder.js").successResponse,
    {
        JWT_SECRET_OR_KEY,
        TOKEN_EXPIRES_IN
    } = require("../../event-schedule/config/serverConfig.js");

// Load User and Event model
const User = require("../../event-schedule/models/User.js"),
    Event = require("../../event-schedule/models/Event.js");

// Load joi validator and validation schema
const Joi = require("joi"),
    newUserSchema = require("../../event-schedule/validation/newUser.js"),
    loginSchema = require("../../event-schedule/validation/login.js"),
    removeUserSchema = require("../../event-schedule/validation/removeUser.js");
...
const {
    ...
    UserNotFound,
    WrongPassword
} = require("../../event-schedule/util/errorTypes.js");
